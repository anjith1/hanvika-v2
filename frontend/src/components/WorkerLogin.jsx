    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <div style={S.logoWrap}>
          ...
          <div style={S.title}>WORKER LOGIN</div>
          <div style={S.subtitle}>HanVika Service Partner Portal</div>
        </div>
        ...
        <div style={S.info}>
          <span>ℹ️</span>
          <span>{activeTab === "login" ? "Sign in to access your work assignments" : "Register as a new service partner"}</span>
        </div>
        ...
        {activeTab === "login" && (
          <form onSubmit={handleLoginSubmit}>
            ...
            <div style={S.footer}>
              New worker?{" "}
              <button type="button" style={S.link} onClick={handleToggle}>Register here</button>
            </div>
          </form>
        )}
